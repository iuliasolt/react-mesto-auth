...
function App() {
    ...
    useEffect(() => {
        if (isProfilePopupOpen || isAddPlacePopupOpen || isEditAvatarPopupOpen || isEditProfilePopupOpen || selectedCard || infoTooltip) 
        {
    ...
    }, [isProfilePopupOpen, isAddPlacePopupOpen, isEditAvatarPopupOpen, isEditProfilePopupOpen, selectedCard, infoTooltip]);
    ...
    return (
        <CurrentUserContext.Provider value={currentUser}>
            ...
            <Route exact path="/" element={
                  <>
                  <Header title="Выйти" mail={emailName} onClick={handleSignOut} route="" />
                   <ProtectedRoute 
                        component={Main}
                        isLogged={isLoggedIn}
